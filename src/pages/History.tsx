...
const milestones = [
  ...
  { year: "Spring 2026", title: "Transition & Launch", description: "With funding secured, the Management Committee worked closely with Robin to plan the handover, recruit and train staff, finalise legal arrangements, and prepare the premises. The community-owned Post Office officially opened its doors, marking a new chapter for Uppingham." },
  { year: "2026+", title: "The Future", description: "Only time will tell, but the aim is to retain a Post Office that has a broad ownership within the community, where people feel it is 'their' post office and where the staff feel an integrated part of that community." },
];

...
const milestones = [
  ...
  { year: "April 2026", title: "Developing Membership", description: "With funding secured, the Management Committee continued to encourage new members, reaching over 200, whilst negotiating the lease and working with Post Office Limited in preparation for the official application." },
